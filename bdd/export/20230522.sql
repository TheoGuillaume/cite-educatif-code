...
--
-- Hôte : agoracgagoracity.mysql.db
-- Généré le : lun. 22 mai 2023 à 15:45
...
--
-- Base de données : `cityeduc`
--

-- --------------------------------------------------------

--
-- Structure de la table `ca_acteur`
--
...
--
-- Déchargement des données de la table `ca_acteur`
--

INSERT INTO `ca_acteur` (`id`, `id_utilisateur`, `nom`, `prenom`, `poste`, `tel_acteur`, `photo_profil`, `date_ins`, `etat`) VALUES
(1, 74, 'Theo', 'Guio', 'Dev', '85 65 55 55 55', '1684745990_eb4b0941aebad03d15ab.png', '2023-05-22 08:59:50', 1),
(2, 75, 'Nadiasina nico', 'Nico', 'Dev', '55 45 84 54 85', '1684751352_b74a048715dde73ecc7c.jpg', '2023-05-22 10:15:18', 1);

-- --------------------------------------------------------

--
-- Structure de la table `cs_antenne`
--
...
--
-- Structure de la table `cs_antenne_jour_horaire`
--
...
CREATE TABLE `cs_antenne_jour_horaire` (
  ...
  `midi` varchar(50) NOT NULL,
  `soir` varchar(50) NOT NULL,
  `date_ins` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `vacances` text,
  `etat` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `cs_categorie`
--
...
--
-- Déchargement des données de la table `cs_categorie`
--
...
--
-- Structure de la table `cs_champ_action`
--
...
--
-- Déchargement des données de la table `cs_champ_action`
--
...
--
-- Structure de la table `cs_jour_horaire`
--
...
--
-- Déchargement des données de la table `cs_jour_horaire`
--
...
--
-- Structure de la table `cs_modalite`
--
...
--
-- Déchargement des données de la table `cs_modalite`
--
...
--
-- Structure de la table `cs_particularite_action`
--
...
--
-- Déchargement des données de la table `cs_particularite_action`
--
...
--
-- Structure de la table `cs_public`
--
...
--
-- Déchargement des données de la table `cs_public`
--
...
--
-- Structure de la table `cs_referent`
--
...
--
-- Structure de la table `cs_struct`
--
...
--
-- Déchargement des données de la table `cs_struct`
--
...
(59, 58, 1, 'Theo Association', 'Siren', '235467892', 'Andoharanofotsy', 'Lot IAV 305K iavoloha', 'guillaumetheo92@gmail.com', '03 46 83 51 68', NULL, 'Matin midi ', 'Structure Test', 'Aide pour les jeunes,pour les porsonnes handicappés            ', '1684755379_0b8281ab71a90830e1ae.png', '2023-04-20 09:45:12', 0),
...
(64, 70, 1, 'Structure Test', 'ST', '012345678', 'Saint-Denis', 'Saint-Denis', 'structuretest@gmail.com', '33 00 12 34 56', NULL, '', 'Nos missions sont trop nombreuses pour être résumées ici.', '', '1684413628_cc61768a356cd7157b55.jpg', '2023-05-18 10:40:28', 1);

-- --------------------------------------------------------

--
-- Structure de la table `cs_territoire`
--
...
--
-- Déchargement des données de la table `cs_territoire`
--
...
--
-- Structure de la table `cs_thematique`
--
...
--
-- Déchargement des données de la table `cs_thematique`
--
...
--
-- Structure de la table `c_acteur_struct`
--
...
--
-- Déchargement des données de la table `c_acteur_struct`
--

INSERT INTO `c_acteur_struct` (`id`, `id_acteur`, `id_struct`, `date_ins`, `etat`) VALUES
(1, 1, 59, '2023-05-22 08:59:50', 2),
(2, 2, 59, '2023-05-22 10:15:18', 0);

-- --------------------------------------------------------

--
-- Structure de la table `c_file_type`
--
...
--
-- Structure de la table `c_notification`
--
...
--
-- Déchargement des données de la table `c_notification`
--

INSERT INTO `c_notification` (`id`, `id_envoyeur`, `id_recepteur`, `lu`, `date_ins`, `etat`) VALUES
(1, 74, 58, 1, '2023-05-22 08:59:50', 1),
(2, 58, 74, 0, '2023-05-22 09:03:27', 1),
(3, 75, 58, 0, '2023-05-22 10:15:18', 1);
...
(2, 2, 'User', 'cite.educative@ville-argenteuil.fr', '$2y$10$U5FakbIeGV.4RATv.zm7mekZDAjFpGpall8EoBPPddJGeEYQHljVm', '2023-04-11 12:19:20', 1, 0),
...
(52, 2, 'User', 'contact@lepoleressources.fr', '$2y$10$.OlT.EEdpSWktNJQ49dGFOEjmjEgRs2seeWoiEaosDPyf2yuX8VwG', '2023-04-17 07:59:31', 1, 0),
...
(58, 2, 'User', 'guillaume.haisoa@gmail.com', '$2y$10$6gs0Bp/J9/9gviHqcihM9.FGfFoNt9lBcP64H5vgf9e/02.RmfdXG', '2023-04-20 09:41:11', 1, 1),
...
(74, 3, 'User', 'guillaume.acteur@gmail.com', '$2y$10$LGu5Lks.uR9gL.5BVOmiEu3XEHUPjEdfqNrQDN9drNnFMLaocCTU.', '2023-05-22 08:58:52', 1, 1),
...
--
-- Structure de la table `c_utilisateur_categorie`
--
...
--
-- Déchargement des données de la table `c_utilisateur_categorie`
--
...
--
-- Structure de la table `c_utilisateur_champ_action`
--
...
--
-- Déchargement des données de la table `c_utilisateur_champ_action`
--
...
--
-- Structure de la table `c_utilisateur_file`
--
...
--
-- Structure de la table `c_utilisateur_files`
--
...
--
-- Déchargement des données de la table `c_utilisateur_files`
--
...
--
-- Structure de la table `c_utilisateur_modalite`
--
...
--
-- Déchargement des données de la table `c_utilisateur_modalite`
--
...
--
-- Structure de la table `c_utilisateur_particularite_action`
--
...
--
-- Déchargement des données de la table `c_utilisateur_particularite_action`
--
...
--
-- Structure de la table `c_utilisateur_public`
--
...
--
-- Déchargement des données de la table `c_utilisateur_public`
--
...
--
-- Structure de la table `c_utilisateur_territoire`
--
...
--
-- Déchargement des données de la table `c_utilisateur_territoire`
--
...
--
-- Structure de la table `c_utilisateur_thematique`
--
...
--
-- Déchargement des données de la table `c_utilisateur_thematique`
--
...
--
-- Doublure de structure pour la vue `v_cs_struct_categorie`
...
--
-- Doublure de structure pour la vue `v_cs_struct_notification`
-- (Voir ci-dessous la vue réelle)
--
...
--
-- Doublure de structure pour la vue `v_cs_stru_user_cat`
-- (Voir ci-dessous la vue réelle)
--
...
--
-- Doublure de structure pour la vue `v_demande_confimer_struct`
-- (Voir ci-dessous la vue réelle)
--
...
--
-- Index pour la table `cs_antenne`
--
...
--
-- Index pour la table `cs_antenne_jour_horaire`
--
...
--
-- Index pour la table `cs_categorie`
--
ALTER TABLE `cs_categorie`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cs_champ_action`
--
ALTER TABLE `cs_champ_action`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cs_jour`
--
ALTER TABLE `cs_jour`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cs_jour_horaire`
--
...
--
-- Index pour la table `cs_modalite`
--
ALTER TABLE `cs_modalite`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cs_particularite_action`
--
ALTER TABLE `cs_particularite_action`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cs_public`
--
ALTER TABLE `cs_public`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cs_referent`
--
...
--
-- Index pour la table `cs_territoire`
--
ALTER TABLE `cs_territoire`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cs_thematique`
--
ALTER TABLE `cs_thematique`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `c_acteur_struct`
--
...
--
-- Index pour la table `c_file_type`
--
ALTER TABLE `c_file_type`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `c_notification`
--
...
--
-- Index pour la table `c_utilisateur`
--
...
--
-- Index pour la table `c_utilisateur_categorie`
--
ALTER TABLE `c_utilisateur_categorie`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `c_utilisateur_champ_action`
--
...
--
-- Index pour la table `c_utilisateur_file`
--
...
--
-- Index pour la table `c_utilisateur_files`
--
...
--
-- Index pour la table `c_utilisateur_modalite`
--
...
--
-- Index pour la table `c_utilisateur_particularite_action`
--
...
--
-- Index pour la table `c_utilisateur_public`
--
...
--
-- Index pour la table `c_utilisateur_territoire`
--
...
--
-- Index pour la table `c_utilisateur_thematique`
--
...
--
-- AUTO_INCREMENT pour la table `ca_acteur`
--
ALTER TABLE `ca_acteur`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `cs_antenne`
--
ALTER TABLE `cs_antenne`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `cs_antenne_jour_horaire`
--
ALTER TABLE `cs_antenne_jour_horaire`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `cs_categorie`
--
ALTER TABLE `cs_categorie`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `cs_champ_action`
--
ALTER TABLE `cs_champ_action`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT pour la table `cs_jour`
--
ALTER TABLE `cs_jour`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `cs_jour_horaire`
--
ALTER TABLE `cs_jour_horaire`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT pour la table `cs_modalite`
--
ALTER TABLE `cs_modalite`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `cs_particularite_action`
--
ALTER TABLE `cs_particularite_action`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT pour la table `cs_public`
--
ALTER TABLE `cs_public`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `cs_referent`
--
ALTER TABLE `cs_referent`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `cs_struct`
--
ALTER TABLE `cs_struct`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT pour la table `cs_territoire`
--
ALTER TABLE `cs_territoire`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `cs_thematique`
--
ALTER TABLE `cs_thematique`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT pour la table `c_acteur_struct`
--
ALTER TABLE `c_acteur_struct`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `c_file_type`
--
ALTER TABLE `c_file_type`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `c_notification`
--
ALTER TABLE `c_notification`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `c_utilisateur`
--
ALTER TABLE `c_utilisateur`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_categorie`
--
ALTER TABLE `c_utilisateur_categorie`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_champ_action`
--
ALTER TABLE `c_utilisateur_champ_action`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_file`
--
ALTER TABLE `c_utilisateur_file`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_files`
--
ALTER TABLE `c_utilisateur_files`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_modalite`
--
ALTER TABLE `c_utilisateur_modalite`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_particularite_action`
--
ALTER TABLE `c_utilisateur_particularite_action`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_public`
--
ALTER TABLE `c_utilisateur_public`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=308;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_territoire`
--
ALTER TABLE `c_utilisateur_territoire`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=304;

--
-- AUTO_INCREMENT pour la table `c_utilisateur_thematique`
--
ALTER TABLE `c_utilisateur_thematique`
...
--
-- Contraintes pour la table `c_acteur_struct`
--
ALTER TABLE `c_acteur_struct`
...
--
-- Contraintes pour la table `c_notification`
--
ALTER TABLE `c_notification`
...
--
-- Contraintes pour la table `c_utilisateur_champ_action`
--
ALTER TABLE `c_utilisateur_champ_action`
...
--
-- Contraintes pour la table `c_utilisateur_file`
--
ALTER TABLE `c_utilisateur_file`
...
--
-- Contraintes pour la table `c_utilisateur_particularite_action`
--
ALTER TABLE `c_utilisateur_particularite_action`
...
--
-- Contraintes pour la table `c_utilisateur_public`
--
ALTER TABLE `c_utilisateur_public`
...
--
-- Contraintes pour la table `c_utilisateur_territoire`
--
ALTER TABLE `c_utilisateur_territoire`
...
--
-- Contraintes pour la table `c_utilisateur_thematique`
--
ALTER TABLE `c_utilisateur_thematique`
