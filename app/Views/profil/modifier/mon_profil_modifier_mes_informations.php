<div id="row justify-content-center">
    ...
    <div class="container">
        <div class="d-flex justify-content-space-between  ">
            <a href="<?= base_url("/profil/modifier/profilModifierNomPrenom"); ?>" class=" w-100 text-muted py-2">
                <span class="float-start"> Nom et prénom</span>
        ...
        <div class="d-flex justify-content-space-between  gap-2">
            <a href="<?= base_url("/profil/modifier/profilModifierPoste"); ?>" class=" w-100 text-muted py-2">
                <span class="float-start">Poste</span>
                <span class="float-end">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                    </svg>
        ...
        <hr class="my-2">
        <div class="d-flex justify-content-space-between  gap-2">
            <a href="<?= base_url("/profil/modifier/profilModifierNomStructure"); ?>" class=" w-100 text-muted py-2">
                <span class="float-start">Nom de ma structure</span>
                <span class="float-end">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                    </svg>
        ...
        <div class="d-flex justify-content-space-between  gap-2">
            <a href="<?= base_url("/profil/modifier/profilModifierAdressMail"); ?>" class=" w-100 text-muted py-2">
                <span class="float-start">Adresse mail</span>
                <span class="float-end">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                    </svg>
        ...
        <div class="d-flex justify-content-space-between  gap-2">
            <a href="<?= base_url("/profil/modifier/profilModifierNumeroTel"); ?>" class=" w-100 text-muted py-2">
                <span class="float-start">Numéro de téléphone</span>
                <span class="float-end">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
                    </svg>
    ...
    <div class=" d-block mb-3 mt-5 text-center">
    
        <a href="<?= base_url("/profil/structureDesactivationProfil"); ?>" class="background: initial;btn btn-link p-3 " style="width: 100%;  color: red;">
