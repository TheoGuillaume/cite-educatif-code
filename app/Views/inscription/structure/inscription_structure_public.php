...
<div class="page page-center">
      <div class="container-tight py-2">
        <div class="text-center mb-4">
          <h1>Les publics aupr&egrave;s desquels vous agissez.</h1>
        </div>
        <p class="text-center mb-3">L'item "Tous" permet de s&eacute;lectionner tous les publics simultan&eacute;ment :</p>
        
        <form class="card card-md" id="myForm" action="<?= base_url("/inscription/structure/inscriptionStructurePublicSave"); ?>" method="POST">
        ...
        <div class="pb-3 pt-2">
            <div class="form-selectgroup form-selectgroup-pills">
                <?php foreach($cs_publics as $cs_public){?>
                    <label class="form-selectgroup-item">
                        <input type="checkbox" id="<?= $cs_public['id'] ?>" name="id_public[]" value="<?= $cs_public['id'] ?>" class="form-selectgroup-input">
            ...
            <div class="row align-items-center mt-3">
                <div class="col-auto">
                        <a href="<?= base_url("/inscription/structure/inscriptionStructureThematique") ?>" class="text-decoration-none text-secondary">
  ...
  // Get the saved checkbox values from local storage
        var savedCheckboxes = localStorage.getItem("public");
        ...
        localStorage.setItem("public", JSON.stringify(checkedCheckboxes));
        });
