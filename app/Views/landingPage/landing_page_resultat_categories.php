        ...
        <div class="tab-pane active show" id="tabs-home-14">
          <div class="row">
            <div class="col-6"><a href="#" class="nav-link">
                <?php echo count($structs) ?> r&eacute;sutats</a></div>
              ...
              <div class="card-body">
                <div class="row g-3 align-items-center">
                  ...
                  <div style="width:7.8rem; height:7rem;">
                    <img  class=" object-fit-cover" width="100%" height="100%" src="<?= base_url("./upload/" . $struct["photo_logo"] . ""); ?>"
                    onerror="this.src='<?= base_url('./static/logos/default.png'); ?>'"
                    >
                  </div>
                  </div>
                  <div class="col">
